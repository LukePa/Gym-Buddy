import {DeleteExerciseRequest} from "../../../models/requests/exercises";
...
export class DeleteExerciseRequestMapper {
    ...
    static fromAny(input: any): DeleteExerciseRequest {
        return {}
    }
}
...
export class DeleteExerciseResponseMapper {
    ...
    static fromAny(input: any): DeleteExerciseResponse {
        return {};
    }
}